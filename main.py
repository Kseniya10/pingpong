...
player_l = Player('racket.jpg', 20, 200, 50, 100, 5)
player_r = Player('racket.jpg', 600, 200, 50, 100, 5)
ball = GameSprite('ball.jpg', 200, 200, 40, 40, 5)
...
lose1 = font1.render('Левый игрок проиграл!', True, (0,0,0))
lose2 = font1.render('Правый игрок проиграл!', True, (0,0,0))
while game:
    for e in event.get():
        if e.type == QUIT:
            game = False
